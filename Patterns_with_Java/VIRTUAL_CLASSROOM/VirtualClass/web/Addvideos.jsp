    ...
    <body background="background.jpg">
     ...
     <form action="upload.jsp"  method="post">
         ...
         <center> 
            ...
            <br>
             <center> <% Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost/virtualclass", "root", "root");
            PreparedStatement st1 = con1.prepareStatement("select * from videos");
