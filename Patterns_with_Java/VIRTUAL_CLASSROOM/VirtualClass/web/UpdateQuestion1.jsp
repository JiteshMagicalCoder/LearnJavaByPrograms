    ...
    <body background="background.jpg">
        <form action="UpdateQuestion" method="post">
            ...
            <%
                ...
                PreparedStatement st = con1.prepareStatement("select * from exams where ExamName=?");
                st.setString(1,sub);
                ResultSet rs = st.executeQuery();
                while(rs.next())
                {
                    id=Integer.toString(rs.getInt("ExamId"));
                }
                PreparedStatement st1 = con1.prepareStatement("select * from questionbank where ExamId=?");
                st1.setString(1, id);
