...
<html>
    ...
    <center>
        <% String name = "", sub = "";int duration=0,question=0;%>
        <%
        ...
        <%
            ...
            PreparedStatement st1 = con1.prepareStatement("select * from exams");
        ...
        <%
            ...
            else 
            {
                if (name.equalsIgnoreCase("select")) {
                    ...
                    sub = name;
                    Connection con2= DriverManager.getConnection("jdbc:mysql://localhost/virtualclass", "root", "root");
